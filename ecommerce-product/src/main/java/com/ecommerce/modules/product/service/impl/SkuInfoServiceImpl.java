...
import com.ecommerce.modules.product.dao.SkuInfoDao;
import com.ecommerce.modules.product.entity.SkuInfoEntity;
import com.ecommerce.modules.product.service.SkuInfoService;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    public PageUtils queryPageByCondition(Map<String, Object> params) {
        ...
        // catelogId 不等于 0，才查。如果等于 0，则查全部
        ...
        if (!StringUtils.isEmpty(max)) {
            try {
                // max 必须是比 0 大的数，才进行 le("price", max) 检索
